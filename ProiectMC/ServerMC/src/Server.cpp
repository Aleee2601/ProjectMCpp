...
//Server::Server(int port)
//    : m_port(port), m_currentMap(std::make_shared<Map>(15, 15)),
//    m_gameSession(std::make_unique<GameSession>(10, 10)) {
//    m_currentMap->GenerateRandomMap();
//    initRoutes();
//}
//
...
//        if (!m_gameSession) {
//            CROW_LOG_ERROR << "GameSession not initialized.";
//            return crow::response(500, "GameSession not initialized.");
//        }
//        if (m_gameSession->CanStartGame()) {
//            m_gameSession->StartGame();
//            GameDAO.create(m_gameSession->GetAllPlayers());
//            CROW_LOG_INFO << "Game started successfully.";
//            return crow::response(200, "Game started.");
//        }
//        CROW_LOG_WARNING << "Game could not start: conditions not met.";
